      ...
      <PageLayout>
          ...
          <div className="p-10 rounded-lg shadow-2xl max-w-md w-full">
            ...
            <p className="text-center text-gray-600 mt-4">
              If you want to update your account, visit your profile.
            </p>
            <div className="flex justify-between mt-6 text-center">
              <button
                className="btn btn-primary bg-blue-500 text-white border-0"
                onClick={() => navigate("/")}
              >
                Home
              </button>
  ...
  return (
    <PageLayout>
      <div className="flex items-center justify-center min-h-screen">
        <div className="p-10 rounded-lg shadow-2xl bg-slate-100 max-w-md w-full">
          ...
          <form onSubmit={onRegisterSubmit} className="space-y-5">
            ...
            <div className="mt-6">
              <button type="submit" className="btn btn-primary bg-blue-500 text-white border-0 mt-6 w-full">
                Register
              </button>
            </div>
            {statusMessage && (
